 ...
 */
class CustomsBrokerPackage extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'Customs_Broker_Package';

    protected $fillable = ['id', 'file_uuid', 'date_received', 'status', 'move_number', 'order_number', 'created_by', 'date_sent', 'date_confirmed', 'date_warning_sent', 'broker_tracing_rpa_status', 'rpa_result', 'rpa_result_count', 'date_rpa_last_check', 'fax_tracking_id', 'broker_send_date', 'broker_id', 'broker_name', 'broker_fax', 'broker_loc', 'broker_email', 'tractor', 'tractor_license', 'trailer', 'trailer_license', 'target_clearance_time', 'ace_status', 'assigned_to', 'delv_instruction', 'priority', 'actioned', 'lgh_driver', 'rpa_manifest_status', 'updated_by', 'updated_date'];
