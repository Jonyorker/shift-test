 ...
 * @property bool $activity_exception
 * @property int $lgh_number
 */
class YardMonitor extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'Yard_Monitor';

    protected $fillable = ['id', 'parent_id', 'created_by', 'created_date', 'activity_date', 'activity_type', 'mov_number', 'primary_driver_id', 'primary_contact', 'secondary_driver_id', 'secondary_contact', 'company_id', 'company_name', 'contact_type', 'unit_number', 'license_plate', 'yard_violation', 'has_ppe', 'has_equipment_damage', 'equipment_damage', 'yard_id', 'scheduled_entry_date', 'scheduled_exit_date', 'comments', 'activity_exception', 'lgh_number'];
