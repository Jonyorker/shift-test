...
return new class extends Migration
{
    ...
    {
        Schema::connection('psbison')->create('log_driverlogs_omnitracs_raw', function (Blueprint $table) {
    ...
    {
        Schema::connection('psbison')->dropIfExists('log_driverlogs_omnitracs_raw');
    }
};
