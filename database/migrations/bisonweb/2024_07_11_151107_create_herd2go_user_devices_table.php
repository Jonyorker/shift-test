...
return new class extends Migration
{
    ...
    {
        Schema::connection('bisonweb')->create('herd2go_user_devices', function (Blueprint $table) {
            $table->increments('id');
            $table->string('emp_id', 10)->nullable();
            $table->string('device_uuid', 50)->nullable()->unique('unk_deviceuuid');
    ...
    {
        Schema::connection('bisonweb')->dropIfExists('herd2go_user_devices');
    }
};
