...
return new class extends Migration
{
    ...
    {
        Schema::connection('bisonweb')->create('customs_broker_load_in_bond_history', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('load_in_bond_id');
    ...
    {
        Schema::connection('bisonweb')->dropIfExists('customs_broker_load_in_bond_history');
    }
};
