...
return new class extends Migration
{
    ...
    {
        Schema::connection('bisonweb')->create('custom_clearance_status_historical', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::connection('bisonweb')->dropIfExists('custom_clearance_status_historical');
    }
};
