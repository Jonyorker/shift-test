...
return new class extends Migration
{
    ...
    {
        Schema::connection('bisonweb')->create('customs_broker_package_history', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::connection('bisonweb')->dropIfExists('customs_broker_package_history');
    }
};
